...
public class BaseClass {
		...
		try {
			if (browerName.equalsIgnoreCase("chrome")) {
				System.setProperty("webdriver.chrome.driver",
						System.getProperty("user.dir") + "C:\\Users\\maniv\\eclipse-workspace\\Selenium_Training\\driver\\chromedriver.exe");
	...
	public static WebDriver importWebmanager(String type) {
